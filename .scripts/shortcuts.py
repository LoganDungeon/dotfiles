...
# These are the labels that demarcate where the shortcuts go in the config files
beg = "# PLACE FOR AUTOGENERATED SHORTCUTS. DO NOT DELETE\n" 
end = "# PLACE FOR AUTOGENERATED SHORTCUTS. DO NOT DELETE" 

# First we open the list of folder shortcuts and go down each in the required syntax to each of the three configs:
...
with open(home + ".scripts/folders") as fold:
    for line in csv.reader(fold, dialect="excel-tab"):
        ...
        bashshortcuts += ("alias " + line [0] + "=\"cd " + line[1] + " && ls\"\n")
        # Add the qutebrowser shortcuts:
        quteshortcuts += "config.bind(';" + line[0] + "', 'set downloads.location.directory " + line[1] + " ;; hint links download')\n"

# Goes thru the config file and adds the shortcuts to both bashshortcuts and ranger.
